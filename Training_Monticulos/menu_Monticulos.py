...
def menu_Monticulos():
    st.header("Los montículos nos muestran el poder de la prioridad y la eficiencia, permitiéndonos gestionar y atender tareas de manera ordenada y efectiva, escalando hacia el éxito con cada paso que damos.")

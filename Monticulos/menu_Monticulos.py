...
from Monticulos.practica_Monticulo import practica
from Monticulos.Explicacion_Monticulos import explicacion
...
def menu_Monticulos():
    ...
    if seleccion =="Explicacion":
        with st.container():
            st.subheader("Bienvenido. aprende e interioriza tus saberes de Monticulos")
            st.write("Los montículos nos muestran el poder de la prioridad y la eficiencia, permitiéndonos gestionar y atender tareas de manera ordenada y efectiva, escalando hacia el éxito con cada paso que damos.en nuestro caso lo adaptamos al tema de la salud")

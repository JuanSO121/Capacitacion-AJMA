...
st.sidebar.subheader("Por favor seleccione el tema que desea aprender")
...
# Diseño de la página
    ...
    st.markdown("---")
    st.write("En esta plataforma de capacitación, tendrán acceso a contenido actualizado y relevante, desde conceptos fundamentales hasta las últimas tendencias y mejores prácticas en el campo de la logística y las soluciones operativas. Nuestros cursos y materiales están desarrollados por expertos en la industria, con una amplia experiencia y conocimientos especializados.")
    ...
    st.write("Los invitamos a explorar nuestros cursos, descargar materiales de estudio, participar en sesiones en vivo y conectarse con otros profesionales de la industria a través de nuestras comunidades en línea. Estamos aquí para apoyar su crecimiento profesional y ayudarles a alcanzar sus metas en el campo de las soluciones operativas y logística.")
